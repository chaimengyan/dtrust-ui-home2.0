...
export default {
  ...
  methods: {
    ...
    echoContent(informKey) {
      ...
      this.agreeRecordApiUrl = `${powerUrl}/workflow/accessRecord/processing`
      // this.addPowerApiUrl = `http://116.205.172.167:38083/workflow/accessResponse`
      this.addPowerApiUrl = `${powerUrl}/workflow/accessResponse`
      ...
      this.allrequestTypeApiUrl = `${powerUrl}/workflow/requestType/getRequestTypeListByCode?tenantCode=${this.tenantCode}`
    },
  },
};
</script>
