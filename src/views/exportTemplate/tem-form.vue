<template>
    <div>
        <el-form ref="temForm" :model="temForm" label-width="100px"   >
      ...
      data() {
        return {
            ...
            temForm: {
                ...
                assessmentSimpleSort: 0,
                assessmentInfo: false,
                assessmentInfoSort: 0,
                riskChart: false,
                riskChartSort: 0,
                riskList: false,
                riskListLevel: 0,
                ...
                evaluationHistorySort: 0,
                sceneAttribute: false,
                sceneAttributeSort: 0,
                assetsAttribute: false,
                assetsAttributeSort: 0,
                rightChart: false,
                rightChartSort: 0,
                // privacyPolicy: true,
                watermark: false,
