<template>
  <div class="termsOfUse">
    <p><strong>使用条款</strong></p> 
        <p>本应用尊重并保护所有使用服务用户的个人隐私权。为了给您提供更准确、更有个性化的服务&#xff0c;本应用会按照本隐私权政策的规定使用和披露您的个人信息。除本隐私权政策另有规定外&#xff0c;在未征得您事先许可的情况下&#xff0c;本应用不会将这些信息对外披露或向第三方提供。 您在同意本应用服务使用协议之时&#xff0c;即视为您已经同意本隐私权政策全部内容。本隐私权政策属于本应用服务使用协议不可分割的一部分。</p> 
        <p><strong>适用范围</strong></p> 
        <p>1、 在您注册本应用帐号时&#xff0c;您根据本应用要求提供的个人注册信息&#xff1b;</p> 
        <p>2、 在您使用本应用网络服务&#xff0c;或访问本应用平台网页时&#xff0c;本应用自动接收并记录的您的浏览器和计算机上的信息&#xff0c;包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据&#xff1b;</p> 
        ...
        <p>3、 为服务用户的目的&#xff0c;本应用可能通过使用您的个人信息&#xff0c;向您提供您感兴趣的信息&#xff0c;包括但不限于向您发出产品和服务信息&#xff0c;或者与本应用合作伙伴共享信息以便他们向您发送有关其产品和服务的信息&#xff08;后者需要您的事先同意&#xff09;。</p> 
        <p> </p> 
        ...
        <p>如果您对本隐私政策有任何疑问、意见或建议&#xff0c;通过以下方式与我们联系&#xff1a;<br />
         邮箱&#xff1a;1773598170&#64;qq.com</p>
  </div>
</template>
